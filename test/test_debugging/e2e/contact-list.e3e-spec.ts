...
describe('the contact list', () => {
  ...
  it('with filter: should find existing contact "Craig Service"', async () => {
  ...
  it('with map: should create a map object', async () => {
    let tbody = element(by.tagName('tbody'));
    let trs = tbody.all(by.tagName('tr'));
  ...
  it('with reduce: get a list of contact names', async () => {
    let tbody = element(by.tagName('tbody'));
    let trs = tbody.all(by.tagName('tr'));
